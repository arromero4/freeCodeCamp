...
any combination of map(), filter(), and reduce(). 
The function should return a new array containing 
the squares of only the positive integers 
(decimal numbers are not integers) when an array of real 
numbers is passed to it. An example of an array of real 
...
const squareList = arr => {
    ...
    let square = arr
    .filter(index => index > 0 && index % 1 == 0)
